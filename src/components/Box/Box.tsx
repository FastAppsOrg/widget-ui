...
// Surface color mappings - can be extended or replaced with CSS variables
...
function resolveBackgroundColor(background: string | { light?: string; dark?: string } | undefined): string | undefined {
  ...
  if (typeof background === 'object') {
    // Theme-aware: for now, use light value (can be enhanced with theme detection)
  ...
  // Return as-is (CSS string or primitive color token)
  return background;
}
